...
import type { Address as _Address, BookingRequest as _BookingRequest, CustomerName as _CustomerName, PhoneNo as _PhoneNo, PreferredDate as _PreferredDate, ServiceType as _ServiceType, Time as _Time } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitBooking(arg0: CustomerName, arg1: PhoneNo, arg2: ServiceType, arg3: PreferredDate, arg4: Address): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitBooking(arg0, arg1, to_candid_ServiceType_n6(this._uploadFile, this._downloadFile, arg2), arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "plumber" in value ? ServiceType.plumber : "cleaning" in value ? ServiceType.cleaning : "electrician" in value ? ServiceType.electrician : "acRepair" in value ? ServiceType.acRepair : "carpenter" in value ? ServiceType.carpenter : value;
}
